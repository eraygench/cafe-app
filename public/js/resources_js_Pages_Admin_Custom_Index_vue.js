            ...
            switch (_context.prev = _context.next) {
              case 0:
                _this2.$swal({
                  ...
                  if (isConfirmed) _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_0__.Inertia["delete"]('/' + _this2.$props.route + '/' + id, {}, {
                    preserveState: true,
                    replace: true,
                    preserveScroll: true
                  });
  ...
  watch: {
    search: {
      handler: lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default()(function (value) {
        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_0__.Inertia.get('/' + _this3.$props.route, {
          search: value
        }, {
          preserveState: true,
          replace: true,
              ...
              [
                _c(
                  "Link",
                  {
                    ...
                    attrs: { href: "/" + _vm.route + "/create", as: "button" },
                  },
                  [
                    _vm._v(
                      "\n                        New\n                    "
