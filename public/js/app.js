...
(0,_inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    ...
    vue__WEBPACK_IMPORTED_MODULE_5__["default"].use((vue_sweetalert2__WEBPACK_IMPORTED_MODULE_0___default()));
    vue__WEBPACK_IMPORTED_MODULE_5__["default"].component('Link', _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_1__.Link);
    vue__WEBPACK_IMPORTED_MODULE_5__["default"].component('Head', _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_1__.Head);
            ...
            [
              ...
              !_vm.$page.props.auth.user.organization_id
                ? _c(
                    ...
                    {
                      class: {
                        "text-orange-600": _vm.$page.url.startsWith("/sales"),
                      },
                      attrs: { href: "/sales" },
                    },
                    [_vm._v("Sales")]
              ...
              !_vm.$page.props.auth.user.organization_id
                ? _c(
                    ...
                    {
                      class: {
                        "text-orange-600": _vm.$page.url.startsWith("/users"),
                      },
                      attrs: { href: "/users" },
                    },
                    [_vm._v("Users")]
              ...
              !_vm.$page.props.auth.user.organization_id
                ? _c(
                    "Link",
                    {
                      class: {
                        "text-orange-600":
                          _vm.$page.url.startsWith("/organizations"),
                      },
              ...
              _vm.$page.props.auth.user.organization_id
                ? _c(
                    "Link",
                    {
                      class: {
                        "text-orange-600":
                          _vm.$page.url.startsWith("/products"),
                      },
                      attrs: { href: "/products" },
                    },
                    [_vm._v("Products")]
              ...
              _vm.$page.props.auth.user.organization_id
                ? _c(
                    "Link",
                    {
                      class: {
                        "text-orange-600":
                          _vm.$page.url.startsWith("/categories"),
                      },
              ...
              _vm.$page.props.auth.user.organization_id
                ? _c(
                    "Link",
                    {
                      class: {
                        "text-orange-600":
                          _vm.$page.component.startsWith("Admin/Plan"),
                      },
                      attrs: { href: "/plan" },
                    },
                    [_vm._v("Desk Plan")]
