      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0",
            },
            [
              _c(
                "h2",
                {
                  staticClass:
                    "text-gray-900 text-lg font-medium title-font mb-5 text-center",
                },
                [_vm._v("Login")]
              ),
              _vm._v(" "),
                ...
                [
                  _c("div", { staticClass: "relative mb-4" }, [
                    ...
                    _vm.form.errors.email
                      ? _c("p", { staticClass: "text-xs text-red-500 mt-3" }, [
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg w-full",
